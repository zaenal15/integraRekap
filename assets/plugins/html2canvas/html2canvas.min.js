    ...
    var DocumentCloner = /** @class */ (function () {
        ...
        DocumentCloner.prototype.cloneNode = function (node) {
            ...
            if (window && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
                ...
                var before = this.resolvePseumainContent(node, clone, styleBefore, PseudoElementType.BEFORE);
                ...
                var after = this.resolvePseumainContent(node, clone, styleAfter, PseudoElementType.AFTER);
                if (after) {
        ...
        DocumentCloner.prototype.resolvePseumainContent = function (node, clone, style, pseudoElt) {
            var _this = this;
            if (!style) {
                return;
            }
